...
export type SiteHeaderNarrowProps = {
  siteName?: string;
        ...
        <nav className="flex items-center gap-0.5 text-[13px]">
          ...
          {onOpenCommand ? (
            <button
              ...
              className="ml-0.5 hidden items-center gap-1 rounded-md border border-border-subtle bg-muted px-1.5 py-[3px] font-mono text-[10.5px] text-muted-foreground hover:border-border-subtle hover:text-foreground sm:inline-flex"
            >
