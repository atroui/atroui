...
/**
 * Keep in sync with registry `@atroui/waitlist-form`
 * (`apps/docs/registry/default/blocks/waitlist-form.tsx`).
 */
const CONTENT = {
  label: "Email",
    ...
    <div>
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <input
          ...
          className={cn(
            "w-full border border-border-subtle bg-background px-3.5 py-2.5 text-sm text-foreground outline-none",
