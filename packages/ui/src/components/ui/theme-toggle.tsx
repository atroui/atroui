  ...
  return (
    <>
      <button
        ...
        onClick={cycle}
        className={cn(
          "motion-safe-transition inline-flex size-9 items-center justify-center rounded-[var(--atro-control-radius)] border border-border-subtle bg-muted text-foreground sm:hidden active:scale-[0.97]",
          className,
        )}
      >
      ...
      <div
        ...
        aria-label="Theme"
        className={cn(
          "touch-manipulation hidden items-stretch overflow-hidden rounded-[var(--atro-control-radius)] border border-border-subtle bg-muted sm:inline-flex",
          className,
        )}
      >
