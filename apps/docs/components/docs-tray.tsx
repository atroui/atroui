        ...
        <div className="flex h-[min(34rem,70vh)] min-h-[28rem] flex-col md:h-[34rem] md:min-h-0">
          ...
          <div className="flex shrink-0 items-center justify-between gap-3 border-t border-border-subtle px-4 py-3 sm:px-5">
            <button
              ...
              className="inline-flex h-9 items-center gap-1.5 rounded-lg border border-border-subtle bg-foreground/[0.04] px-3 text-[13px] font-medium text-foreground transition-colors enabled:hover:bg-foreground/[0.06] disabled:cursor-not-allowed disabled:opacity-35"
            >
