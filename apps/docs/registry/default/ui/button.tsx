...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center border border-transparent bg-clip-padding text-[0.8125rem] font-medium tracking-[-0.01em] whitespace-nowrap outline-none select-none transition-[opacity,background-color,border-color,box-shadow,color] duration-150 ease-[cubic-bezier(0.16,1,0.3,1)] focus-visible:border-ring disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-2 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 motion-reduce:transition-none",
  {
    variants: {
      variant: {
        default:
          ...
          <motion.button
            whileHover={
              skipMotion
                ? undefined
                : hoverPrimary
                  ? { ...hoverLift, transition: hoverTween }
                  : gestures.whileHover
            }
