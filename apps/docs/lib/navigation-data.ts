...
/**
 * Curated docs catalog data — consumed by `@/lib/docs-page-tree`.
 * Do not import this from UI; use `@/lib/navigation` or `@/lib/docs-page-tree`.
 */
export const navigation: NavSection[] = [
  {
    title: "Getting Started",
    items: [
      { title: "Introduction", href: "/docs", description: "Own the UI" },
      {
        title: "Installation",
